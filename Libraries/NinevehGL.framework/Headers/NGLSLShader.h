 ...
 *
 *	@see			NGLSLShader::addHeader:mode:
 *	@see			NGLSLShader::addBody:mode:
 *	@see			NGLSLShader::addFromFile:mode:
 *	@see			NGLSLShader::addFromString:mode:
 *	@see			NGLSLShader::addFromShader:mode:
 *	
 *	@var			NGLSLAddModeSet
 ...
 *
 *					NGLSLShader is prepared to integrate many shader files and/or strings into one single
 *					shader. You can set the header and body of the shader separately.
 */
@interface NGLSLShader : NSObject
{
@private
	// Contents
 ...
 *
 *	@result			A new initialized NGLSLShader instance.
 */
