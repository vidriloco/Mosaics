 ...
 *					The attenuation factor represents the depth necessary for the light lose around 5% of its
 *					power. For example, attenuation factor of 2.0 means that an object distant from
