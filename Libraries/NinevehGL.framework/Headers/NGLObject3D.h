...
/*!
 *					The bounding box of this object. This information can't be changed externally only for
 *					subclasses of NGLObject3D. It's based on the internal object structure, if it has one.
 *
 ...
 *
 *					By default, the box will be filled with zero values. The subclasses should change
 *					those values to alter the bounding box calculations.
 *
 *	@see			NGLBoundingBox
 */
