 ...
 *						- <strong>vec3 v_nglVEye</strong>: [optional] Used only when exist Light Effect.
 *							It's the calculated "Eye Vector", which is used in many light computations.
 *						- <strong>vec3 v_nglVLight</strong>: [optional] Used only when exist Light Effect.
 ...
 *						- <strong>float v_nglLightLevel</strong>: [optional] Only when exist Light Effect.
 *							It's the calculated light intensity, which is used in many light computations.
 *						- <strong>float _nglLightD</strong>: [optional] Used only when exist Light Effect.
 ...
 *						- <strong>float _nglShineD</strong>: [optional] Used only when exist Light Effect.
 ...
 *						- <strong>float v_nglFog</strong>: [optional] Used only when exist Fog effect.
