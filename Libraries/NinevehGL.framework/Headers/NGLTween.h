...
/*!
 *					The name key to the #NGLTween#. Its value must be a NSString.
 */
NGL_API NSString *const kNGLTweenKeyName;

/*!
 *					The ease key to the #NGLTween#. Its value must be a NSString or NSValue with a pointer
...
/*!
 *					The delay key to the #NGLTween#. Its value must be a NSString or NSNumber.
 *
...
/*!
 *					The paused key to the #NGLTween#. Its value must be a NSString.
 *
 *					Its value must be #kNGLTweenPausedYes# to create a paused tween.
 *
 *	@see			kNGLTweenPausedYes
 */
NGL_API NSString *const kNGLTweenKeyPaused;
...
/*!
 *					The reverse instruction key to the #NGLTween#. Its value must be a NSString.
 *
 *					The NSString can be:
 *
...
/*!
 *					The reverse count key to the #NGLTween#. Its value must be a NSString or NSNumber.
 *
...
/*!
 *					The repeat delay key to the #NGLTween#. Its value must be a NSString or NSNumber.
 *
...
/*!
 *					The override key to the #NGLTween#. Its value must be a NSString.
 *
 *					The NSString can be:
 *
...
/*!
 *					Value to the #kNGLTweenKeyPaused#.
 *
 *					With this value, the tween will not start automatically.
 */
NGL_API NSString *const kNGLTweenPausedYes;
...
@private
	...
	unsigned int			_cycle, _repeatCycles;
	BOOL					_repeating;
	BOOL					_mirrored;
	BOOL					_paused;
	float					_delay;
...
/*!
 *					Acts as #stopTween:# method, but working for all the current tweens. The tweens will
 *					receive a #finishTween# message.
 *
 *	@param			option
 *					The type of the stopping. The tween can stop at the very current moment with the
 *					current state or stop with the initial state. The finished states is about the
 ...
 *					The tweens will receive a #finishTween# message.
 *
 *	@param			option
 *					The type of the stopping. The tween can stop at the very current moment with the
 *					current state or stop with the initial state. The finished states is about the
