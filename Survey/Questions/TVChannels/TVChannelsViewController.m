...
@implementation TVChannelsViewController
...
{        
    ...
    // Background image
    UIImageView *background = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"background_tv.png"]];
    ...
    for (int i = 0; i < [categories count]; ++i) {
        ...
        // slider
        FBSliderWithOptions *slider = [[FBSliderWithOptions alloc] initWithFrame:CGRectMake(xPos + sliderOffset, yPos + step * i + label.frame.size.height, sliderWidth, 30)];                            
        slider.enabled = NO;
